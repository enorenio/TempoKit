  ...
  Widget build(BuildContext context) {
    return RaisedButton(
      ...
      child: Text(
        'LOG OUT',
        style: TextStyle(
            color: Colors.amber[800], fontSize: 14.0, fontWeight: FontWeight.bold),
      ),
    );
  }
}
